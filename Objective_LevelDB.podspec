Pod::Spec.new do |s|
  ...
  s.homepage     =  'https://github.com/tangbinqi/Objective-LevelDB'
  s.authors      =  'Michael Hoisie', 'Mathieu D\'Amours'

  s.ios.deployment_target = '5.0'
  s.osx.deployment_target = '10.7'

  s.source       =  { :git => 'https://github.com/tangbinqi/Objective-LevelDB.git', :tag => s.version.to_s, :submodules => true }

  s.source_files = 'Classes/*.{h,m,mm}'
  s.dependency "leveldb_library", "~> 1.18.2"
